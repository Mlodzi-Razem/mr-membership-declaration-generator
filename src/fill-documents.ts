...
export function fillGdprDeclaration(context: DownloadFilesContext): Promise<Blob> {
...
export function fillParentalConsentForm(context: DownloadFilesContext): Promise<Blob> {
